                    ...
                    <ul class="mt-8">
                        ...
                        <div x-data="{ open: false }">
                                ...
                                <ul x-show="open" class="ml-4 mt-2 space-y-2">
                                    <li><a href="{{ route('admin.all.users')}}" class="text-gray-300 hover:text-white">All User</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="my-3">
                        ...
                        <li class="my-3">
                            <div x-data="{ open: false }">
                                ...
                                <ul x-show="open" class="ml-4 mt-2 space-y-2">
                                    ...
                                    <li><a href="{{ route ('admin.all.approved.loans')}}" class="text-gray-300 hover:text-white">View Approved Loan</a></li>
