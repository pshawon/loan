                ...
                <div class="relative inline-block text-gray-200">
                    ...
                    <div class="flex items-center space-x-4" id="profileButton">
                        ...
                        <div>
                            ...
                            <button class="dropdown-icon" style="font-size: 08px;">&#9660;</button></p>
                        </div>

                    </div>
                    <ul id="profileDropdown" class="hidden mt-2 py-2 w-32 bg-white border rounded-lg shadow-lg absolute right-0" x-cloak>
                        <li><a href="{{ route('super_admin.profile')}}" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">My Profile</a></li>
                        <li><a href="{{ route('super_admin.password.update')}}" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Change Password</a></li>
                        <li>
